// this sheet is created to change the default modal bottom sheet
...
class _FullScreenModalBottomSheet<T> extends StatefulWidget {
  const _FullScreenModalBottomSheet({
    super.key,
    required this.route,
    this.backgroundColor,
    this.dragHandleColor,
  ...
  final FullScreenModalBottomSheetRoute<T> route;
  final bool isScrollControlled;
  final Color? backgroundColor;
  final Color? dragHandleColor;
  final double? elevation;
  ...
  @override
  _FullScreenModalBottomSheetState<T> createState() =>
      _FullScreenModalBottomSheetState<T>();
}

class _FullScreenModalBottomSheetState<T>
    extends State<_FullScreenModalBottomSheet<T>> {
...
///  * The Material 2 spec at <https://m2.material.io/components/sheets-bottom>.
///  * The Material 3 spec at <https://m3.material.io/components/bottom-sheets/overview>.
class FullScreenModalBottomSheetRoute<T> extends PopupRoute<T> {
  /// A modal bottom sheet route.
  FullScreenModalBottomSheetRoute({
    required this.builder,
    this.capturedThemes,
    this.barrierLabel,
      ...
      child: Builder(
        builder: (BuildContext context) {
          ...
          final BottomSheetThemeData defaults = Theme.of(context).useMaterial3
              ? _BottomSheetDefaultsM3(context)
              : const BottomSheetThemeData();
          return _FullScreenModalBottomSheet<T>(
            route: this,
...
///  * The Material 2 spec at <https://m2.material.io/components/sheets-bottom>.
///  * The Material 3 spec at <https://m3.material.io/components/bottom-sheets/overview>.
Future<T?> showFullScreenModalBottomSheet<T>({
  ...
  return navigator.push(FullScreenModalBottomSheetRoute<T>(
    builder: builder,
    capturedThemes:
